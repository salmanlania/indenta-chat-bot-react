...
import { Table, TableHead, TableBody, TableRow, TableCell, Grid, Container, Button, Dialog, DialogContent, DialogTitle, IconButton, } from '@mui/material';

export default function LawBookFaqsIndexPage() {
    return (
        <div>
            <Table>
                <TableHead>
                ...
                <TableBody>
                    ...
                    {/* ============================= ctPart Sixteen Start============================= */}

                    <TableRow>
                        <TableCell>117</TableCell>
                        <TableCell style={{ textAlign: 'center' }}>
                            <a href='#ctPartFifteenFirst' style={{ textDecoration: 'none', fontSize: '1rem', color: 'black' }}>Who is a Natural Person?</a>
                        </TableCell>
                    </TableRow>
                    <TableRow sx={{ background: '#CDDCE8' }}>
                        <TableCell>118</TableCell>
                        <TableCell style={{ textAlign: 'center' }}>
                            <a href='#ctPartFifteenSecond' style={{ textDecoration: 'none', fontSize: '1rem', color: 'black' }}>Will individuals be subject to UAE CT?</a>
                        </TableCell>
                    </TableRow>
                    <TableRow>
                        <TableCell>119</TableCell>
                        <TableCell style={{ textAlign: 'center' }}>
                            <a href='#ctPartFifteenThird' style={{ textDecoration: 'none', fontSize: '1rem', color: 'black' }}>What is the UAE CT treatment of a sole proprietorship or civil company?</a>
                        </TableCell>
                    </TableRow>
                    <TableRow sx={{ background: '#CDDCE8' }}>
                        <TableCell>120</TableCell>
                        <TableCell style={{ textAlign: 'center' }}>
                            <a href='#ctPartFifteenFourth' style={{ textDecoration: 'none', fontSize: '1rem', color: 'black' }}>Will an individual be subject to UAE CT on business income earned outside the UAE?</a>
                        </TableCell>
                    </TableRow>
                    <TableRow>
                        <TableCell>121</TableCell>
                        <TableCell style={{ textAlign: 'center' }}>
                            <a href='#ctPartFifteenFifth' style={{ textDecoration: 'none', fontSize: '1rem', color: 'black' }}>What if an individual has multiple business activities that are in the scope of UAE CT?</a>
                        </TableCell>
                    </TableRow>
                    <TableRow sx={{ background: '#CDDCE8' }}>
                        <TableCell>122</TableCell>
                        <TableCell style={{ textAlign: 'center' }}>
                            <a href='#ctPartFifteenSixth' style={{ textDecoration: 'none', fontSize: '1rem', color: 'black' }}>Will an individual’s employment income be subject to UAE CT?</a>
                        </TableCell>
                    </TableRow>
                    <TableRow>
                        <TableCell>123</TableCell>
                        <TableCell style={{ textAlign: 'center' }}>
                            <a href='#ctPartFifteenSeventh' style={{ textDecoration: 'none', fontSize: '1rem', color: 'black' }}>Will self-employed persons (e.g. freelancers) be subject to UAE CT?</a>
                        </TableCell>
                    </TableRow>
                    <TableRow sx={{ background: '#CDDCE8' }}>
                        <TableCell>124</TableCell>
                        <TableCell style={{ textAlign: 'center' }}>
                            <a href='#ctPartFifteenEighth' style={{ textDecoration: 'none', fontSize: '1rem', color: 'black' }}>Will income earned by an individual from bank deposits be subject to UAE CT?</a>
                        </TableCell>
                    </TableRow>
                    <TableRow>
                        <TableCell>125</TableCell>
                        <TableCell style={{ textAlign: 'center' }}>
                            <a href='#ctPartFifteenNinth' style={{ textDecoration: 'none', fontSize: '1rem', color: 'black' }}>Will an individual be subject to UAE CT on investment returns?</a>
                        </TableCell>
                    </TableRow>
                    <TableRow sx={{ background: '#CDDCE8' }}>
                        <TableCell>126</TableCell>
                        <TableCell style={{ textAlign: 'center' }}>
                            <a href='#ctPartFifteenTenth' style={{ textDecoration: 'none', fontSize: '1rem', color: 'black' }}>Will an individual be subject to UAE CT on income from real estate?</a>
                        </TableCell>
                    </TableRow>
                    ...
                    <TableRow>
                        ...
                        <TableCell style={{ textAlign: 'center' }}>
                            <a href='#ctPartSixteenFirst' style={{ textDecoration: 'none', fontSize: '1rem', color: 'black' }}>How will the UAE CT regime apply to partnerships?</a>
                        </TableCell>
                    </TableRow>
                    <TableRow sx={{ background: '#CDDCE8' }}>
                        <TableCell>128</TableCell>
                        <TableCell style={{ textAlign: 'center' }}>
                            <a href='#ctPartSixteenSecond' style={{ textDecoration: 'none', fontSize: '1rem', color: 'black' }}>Will each partner in an “unincorporated” partnership be required to register and file a UAE CT return?</a>
                        </TableCell>
                    </TableRow>
                    <TableRow>
                        <TableCell>129</TableCell>
                        <TableCell style={{ textAlign: 'center' }}>
                            <a href='#ctPartSixteenThird' style={{ textDecoration: 'none', fontSize: '1rem', color: 'black' }}>How will foreign partnerships be treated under the Corporate Tax Law?</a>
                        </TableCell>
                    </TableRow>

                    {/* ============================= ctPart Sixteen End============================= */}

                    {/* ============================= ctPart Seventeen Start=========================== */}

                    <TableRow sx={{ background: '#CDDCE8' }}>
                        <TableCell>130</TableCell>
                        <TableCell style={{ textAlign: 'center' }}>
                            <a href='#ctPartSeventeenFirst' style={{ textDecoration: 'none', fontSize: '1rem', color: 'black' }}>What is a “Business” or “Business Activity”?</a>
                        </TableCell>
                    </TableRow>
                    <TableRow>
                        <TableCell>131</TableCell>
                        <TableCell style={{ textAlign: 'center' }}>
                            <a href='#ctPartSeventeenSecond' style={{ textDecoration: 'none', fontSize: '1rem', color: 'black' }}>Who is exempt from UAE CT?</a>
                        </TableCell>
                    </TableRow>
                    <TableRow sx={{ background: '#CDDCE8' }}>
                        <TableCell>132</TableCell>
                        <TableCell style={{ textAlign: 'center' }}>
                            <a href='#ctPartSeventeenThird' style={{ textDecoration: 'none', fontSize: '1rem', color: 'black' }}>Who is considered resident for UAE CT purposes?</a>
                        </TableCell>
                    </TableRow>
                    <TableRow>
                        <TableCell>133</TableCell>
                        <TableCell style={{ textAlign: 'center' }}>
                            <a href='#ctPartSeventeenFourth' style={{ textDecoration: 'none', fontSize: '1rem', color: 'black' }}>Who is considered non-resident for UAE CT purposes?</a>
                        </TableCell>
                    </TableRow>
                    <TableRow sx={{ background: '#CDDCE8' }}>
                        <TableCell>134</TableCell>
                        <TableCell style={{ textAlign: 'center' }}>
                            <a href='#ctPartSeventeenFifth' style={{ textDecoration: 'none', fontSize: '1rem', color: 'black' }}>How are non-residents subject to UAE CT?</a>
                        </TableCell>
                    </TableRow>
                    <TableRow>
                        <TableCell>135</TableCell>
                        <TableCell style={{ textAlign: 'center' }}>
                            <a href='#ctPartSeventeenSixth' style={{ textDecoration: 'none', fontSize: '1rem', color: 'black' }}>How are UAE tax residents subject to UAE CT?</a>
                        </TableCell>
                    </TableRow>
                    <TableRow sx={{ background: '#CDDCE8' }}>
                        <TableCell>136</TableCell>
                        <TableCell style={{ textAlign: 'center' }}>
                            <a href='#ctPartSeventeenSeventh' style={{ textDecoration: 'none', fontSize: '1rem', color: 'black' }}>How do you determine taxable income for UAE CT?</a>
                        </TableCell>
                    </TableRow>
                    <TableRow>
                        <TableCell>137</TableCell>
                        <TableCell style={{ textAlign: 'center' }}>
                            <a href='#ctPartSeventeenEighth' style={{ textDecoration: 'none', fontSize: '1rem', color: 'black' }}>What is a Tax Period?</a>
                        </TableCell>
                    </TableRow>
                    <TableRow sx={{ background: '#CDDCE8' }}>
                        <TableCell>138</TableCell>
                        <TableCell style={{ textAlign: 'center' }}>
                            <a href='#ctPartSeventeenNinth' style={{ textDecoration: 'none', fontSize: '1rem', color: 'black' }}>What are the UAE CT rates?</a>
                        </TableCell>
                    </TableRow>
                    <TableRow>
                        <TableCell>139</TableCell>
                        <TableCell style={{ textAlign: 'center' }}>
                            <a href='#ctPartSeventeenTenth' style={{ textDecoration: 'none', fontSize: '1rem', color: 'black' }}>If a business has earned taxable income of AED 1 million, what will be the UAE CT amount payable?</a>
                        </TableCell>
                    </TableRow>
                    <TableRow sx={{ background: '#CDDCE8' }}>
                        <TableCell>140</TableCell>
                        <TableCell style={{ textAlign: 'center' }}>
                            <a href='#ctPartSeventeenEleventh' style={{ textDecoration: 'none', fontSize: '1rem', color: 'black' }}>Will small businesses be given any UAE CT relief?</a>
                        </TableCell>
                    </TableRow>
                    <TableRow>
                        <TableCell>141</TableCell>
                        <TableCell style={{ textAlign: 'center' }}>
                            <a href='#ctPartSeventeenTwelveth' style={{ textDecoration: 'none', fontSize: '1rem', color: 'black' }}>Who can claim small business relief for UAE CT purposes?</a>
                        </TableCell>
                    </TableRow>
                    <TableRow sx={{ background: '#CDDCE8' }}>
                        <TableCell>142</TableCell>
                        <TableCell style={{ textAlign: 'center' }}>
                            <a href='#ctPartSeventeenThirteenth' style={{ textDecoration: 'none', fontSize: '1rem', color: 'black' }}>What is revenue?</a>
                        </TableCell>
                    </TableRow>

                    {/* ============================= ctPart Seventeen End============================= */}

                    {/* ============================= ctPart Eighteen Start=========================== */}

                    <TableRow>
                        <TableCell>143</TableCell>
                        <TableCell style={{ textAlign: 'center' }}>
                            <a href='#ctPartEighteenFirst' style={{ textDecoration: 'none', fontSize: '1rem', color: 'black' }}>Will the oil and gas sector and other extractive industries be subject to UAE CT?</a>
                        </TableCell>
                    </TableRow>
                    <TableRow sx={{ background: '#CDDCE8' }}>
                        <TableCell>144</TableCell>
                        <TableCell style={{ textAlign: 'center' }}>
                            <a href='#ctPartEighteenSecond' style={{ textDecoration: 'none', fontSize: '1rem', color: 'black' }}>Will the banking sector be subject to UAE CT?</a>
                        </TableCell>
                    </TableRow>
                    <TableRow>
                        <TableCell>145</TableCell>
                        <TableCell style={{ textAlign: 'center' }}>
                            <a href='#ctPartEighteenThird' style={{ textDecoration: 'none', fontSize: '1rem', color: 'black' }}>Will the real state sector be subject to UAE CT?</a>
                        </TableCell>
                    </TableRow>
                    <TableRow sx={{ background: '#CDDCE8' }}>
                        <TableCell>146</TableCell>
                        <TableCell style={{ textAlign: 'center' }}>
                            <a href='#ctPartEighteenFourth' style={{ textDecoration: 'none', fontSize: '1rem', color: 'black' }}>Will the asset management sector be subject to UAE CT?</a>
                        </TableCell>
                    </TableRow>
                    <TableRow>
                        <TableCell>147</TableCell>
                        <TableCell style={{ textAlign: 'center' }}>
                            <a href='#ctPartEighteenFifth' style={{ textDecoration: 'none', fontSize: '1rem', color: 'black' }}>Will charities and other public benefit organisations be subject to UAE CT?</a>
                        </TableCell>
                    </TableRow>
                    <TableRow sx={{ background: '#CDDCE8' }}>
                        <TableCell>148</TableCell>
                        <TableCell style={{ textAlign: 'center' }}>
                            <a href='#ctPartEighteenSixth' style={{ textDecoration: 'none', fontSize: '1rem', color: 'black' }}>How will international airlines and shipping companies be taxed?</a>
                        </TableCell>
                    </TableRow>

                    {/* ============================= ctPart Eighteen End============================= */}

                    {/* ============================= ctPart Ninteen Start=========================== */}

                    <TableRow>
                        <TableCell>149</TableCell>
                        <TableCell style={{ textAlign: 'center' }}>
                            <a href='#ctPartNinteenFirst' style={{ textDecoration: 'none', fontSize: '1rem', color: 'black' }}>What is withholding tax?</a>
                        </TableCell>
                    </TableRow>
                    <TableRow sx={{ background: '#CDDCE8' }}>
                        <TableCell>150</TableCell>
                        <TableCell style={{ textAlign: 'center' }}>
                            <a href='#ctPartNinteenSecond' style={{ textDecoration: 'none', fontSize: '1rem', color: 'black' }}>Does the UAE CT regime have withholding tax?</a>
                        </TableCell>
                    </TableRow>
                    <TableRow>
                        <TableCell>151</TableCell>
                        <TableCell style={{ textAlign: 'center' }}>
                            <a href='#ctPartNinteenThird' style={{ textDecoration: 'none', fontSize: '1rem', color: 'black' }}>Is a credit available for foreign tax paid on income that is also subject to UAE CT?</a>
                        </TableCell>
                    </TableRow>
                    <TableRow sx={{ background: '#CDDCE8' }}>
                        <TableCell>152</TableCell>
                        <TableCell style={{ textAlign: 'center' }}>
                            <a href='#ctPartNinteenFourth' style={{ textDecoration: 'none', fontSize: '1rem', color: 'black' }}>What foreign taxes can be credited against UAE CT?</a>
                        </TableCell>
                    </TableRow>

                    {/* ============================= ctPart Ninteen End============================= */}

                    {/* ============================= ctPart twentieth Start=========================== */}

                    <TableRow>
                        <TableCell>153</TableCell>
                        <TableCell style={{ textAlign: 'center' }}>
                            <a href='#ctParttwentiethFirst' style={{ textDecoration: 'none', fontSize: '1rem', color: 'black' }}>Will a group of UAE companies be able to form a Tax Group for UAE CT purposes?</a>
                        </TableCell>
                    </TableRow>
                    <TableRow sx={{ background: '#CDDCE8' }}>
                        <TableCell>154</TableCell>
                        <TableCell style={{ textAlign: 'center' }}>
                            <a href='#ctParttwentiethSecond' style={{ textDecoration: 'none', fontSize: '1rem', color: 'black' }}>Can UAE subsidiaries of a foreign parent company form a Tax Group for UAE CT purposes?</a>
                        </TableCell>
                    </TableRow>
                    <TableRow>
                        <TableCell>155</TableCell>
                        <TableCell style={{ textAlign: 'center' }}>
                            <a href='#ctParttwentiethThird' style={{ textDecoration: 'none', fontSize: '1rem', color: 'black' }}>Can foreign entities be included in a Tax Group?</a>
                        </TableCell>
                    </TableRow>
                    <TableRow sx={{ background: '#CDDCE8' }}>
                        <TableCell>156</TableCell>
                        <TableCell style={{ textAlign: 'center' }}>
                            <a href='#ctParttwentiethFourth' style={{ textDecoration: 'none', fontSize: '1rem', color: 'black' }}>Will the 0% CT rate threshold apply to the Tax Group as a whole?</a>
                        </TableCell>
                    </TableRow>
                    <TableRow>
                        <TableCell>157</TableCell>
                        <TableCell style={{ textAlign: 'center' }}>
                            <a href='#ctParttwentiethFifth' style={{ textDecoration: 'none', fontSize: '1rem', color: 'black' }}>Who will be responsible for the filing of the UAE CT and for payment of the UAE CT due once a Tax Group is formed?</a>
                        </TableCell>
                    </TableRow>
                    <TableRow sx={{ background: '#CDDCE8' }}>
                        <TableCell>158</TableCell>
                        <TableCell style={{ textAlign: 'center' }}>
                            <a href='#ctParttwentiethSixth' style={{ textDecoration: 'none', fontSize: '1rem', color: 'black' }}>Will the Tax Group need to prepare consolidated financial statements?</a>
                        </TableCell>
                    </TableRow>

                    {/* ============================= ctPart twentieth End============================= */}

                    {/* ============================= ctPart twentyFirst Start=========================== */}

                    <TableRow>
                        <TableCell>159</TableCell>
                        <TableCell style={{ textAlign: 'center' }}>
                            <a href='#ctPartTwentyFirstFirst' style={{ textDecoration: 'none', fontSize: '1rem', color: 'black' }}>What is taxable income?</a>
                        </TableCell>
                    </TableRow>
                    <TableRow sx={{ background: '#CDDCE8' }}>
                        <TableCell>160</TableCell>
                        <TableCell style={{ textAlign: 'center' }}>
                            <a href='#ctPartTwentyFirstSecond' style={{ textDecoration: 'none', fontSize: '1rem', color: 'black' }}>What standards must be used to prepare financial statements?</a>
                        </TableCell>
                    </TableRow>
                    <TableRow>
                        <TableCell>161</TableCell>
                        <TableCell style={{ textAlign: 'center' }}>
                            <a href='#ctPartTwentyFirstThird' style={{ textDecoration: 'none', fontSize: '1rem', color: 'black' }}>Will financial statements need to be prepared on an accruals basis?</a>
                        </TableCell>
                    </TableRow>
                    <TableRow sx={{ background: '#CDDCE8' }}>
                        <TableCell>162</TableCell>
                        <TableCell style={{ textAlign: 'center' }}>
                            <a href='#ctPartTwentyFirstFourth' style={{ textDecoration: 'none', fontSize: '1rem', color: 'black' }}>What UAE CT adjustments to the financial statements will be required to calculate taxable income?</a>
                        </TableCell>
                    </TableRow>
                    <TableRow>
                        <TableCell>163</TableCell>
                        <TableCell style={{ textAlign: 'center' }}>
                            <a href='#ctPartTwentyFirstFifth' style={{ textDecoration: 'none', fontSize: '1rem', color: 'black' }}>What is the UAE CT treatment for any unrealised gains and losses arising from accounting fair value or impairment adjustments?</a>
                        </TableCell>
                    </TableRow>
                    <TableRow sx={{ background: '#CDDCE8' }}>
                        <TableCell>164</TableCell>
                        <TableCell style={{ textAlign: 'center' }}>
                            <a href='#ctPartTwentyFirstSixth' style={{ textDecoration: 'none', fontSize: '1rem', color: 'black' }}>What is the realisation principle, and when is income realised for UAE CT purposes?</a>
                        </TableCell>
                    </TableRow>
                    <TableRow>
                        <TableCell>165</TableCell>
                        <TableCell style={{ textAlign: 'center' }}>
                            <a href='#ctPartTwentyFirstSeventh' style={{ textDecoration: 'none', fontSize: '1rem', color: 'black' }}>How are capital gains taxed?</a>
                        </TableCell>
                    </TableRow>

                    {/* ============================= ctPart twentyFirst End============================= */}

                    {/* ============================= ctPart twentySecond Start=========================== */}

                    <TableRow sx={{ background: '#CDDCE8' }}>
                        <TableCell>166</TableCell>
                        <TableCell style={{ textAlign: 'center' }}>
                            <a href='#ctPartTwentySecondFirst' style={{ textDecoration: 'none', fontSize: '1rem', color: 'black' }}>Will transfer pricing rules apply to both domestic and cross border transactions?</a>
                        </TableCell>
                    </TableRow>
                    <TableRow>
                        <TableCell>167</TableCell>
                        <TableCell style={{ textAlign: 'center' }}>
                            <a href='#ctPartTwentySecondSecond' style={{ textDecoration: 'none', fontSize: '1rem', color: 'black' }}>What are transfer pricing rules?</a>
                        </TableCell>
                    </TableRow>
                    <TableRow sx={{ background: '#CDDCE8' }}>
                        <TableCell>168</TableCell>
                        <TableCell style={{ textAlign: 'center' }}>
                            <a href='#ctPartTwentySecondThird' style={{ textDecoration: 'none', fontSize: '1rem', color: 'black' }}>Who are Related Parties?</a>
                        </TableCell>
                    </TableRow>
                    <TableRow>
                        <TableCell>169</TableCell>
                        <TableCell style={{ textAlign: 'center' }}>
                            <a href='#ctPartTwentySecondFourth' style={{ textDecoration: 'none', fontSize: '1rem', color: 'black' }}>Who are Connected Persons?</a>
                        </TableCell>
                    </TableRow>
                    <TableRow sx={{ background: '#CDDCE8' }}>
                        <TableCell>170</TableCell>
                        <TableCell style={{ textAlign: 'center' }}>
                            <a href='#ctPartTwentySecondFifth' style={{ textDecoration: 'none', fontSize: '1rem', color: 'black' }}>What transfer pricing methodologies can be used to determine the arm`s length value?</a>
                        </TableCell>
                    </TableRow>
                    <TableRow>
                        <TableCell>171</TableCell>
                        <TableCell style={{ textAlign: 'center' }}>
                            <a href='#ctPartTwentySecondSixth' style={{ textDecoration: 'none', fontSize: '1rem', color: 'black' }}>What documentation should be maintained in respect of transfer pricing?</a>
                        </TableCell>
                    </TableRow>
                    <TableRow sx={{ background: '#CDDCE8' }}>
                        <TableCell>172</TableCell>
                        <TableCell style={{ textAlign: 'center' }}>
                            <a href='#ctPartTwentySecondSeventh' style={{ textDecoration: 'none', fontSize: '1rem', color: 'black' }}>Do taxpayers need to consider whether intra-group loan arrangements are at arm`s length?</a>
                        </TableCell>
                    </TableRow>
                    <TableRow>
                        <TableCell>173</TableCell>
                        <TableCell style={{ textAlign: 'center' }}>
                            <a href='#ctPartTwentySecondEighth' style={{ textDecoration: 'none', fontSize: '1rem', color: 'black' }}>Would transactions in a Tax Group need to comply with transfer pricing rules?</a>
                        </TableCell>
                    </TableRow>

                    {/* ============================= ctPart twentySecond End============================= */}

                    {/* ============================= ctPart twentyThird Start=========================== */}

                    <TableRow sx={{ background: '#CDDCE8' }}>
                        <TableCell>174</TableCell>
                        <TableCell style={{ textAlign: 'center' }}>
                            <a href='#ctPartTwentyThirdFirst' style={{ textDecoration: 'none', fontSize: '1rem', color: 'black' }}>What is a “Family Foundation”?</a>
                        </TableCell>
                    </TableRow>
                    <TableRow>
                        <TableCell>175</TableCell>
                        <TableCell style={{ textAlign: 'center' }}>
                            <a href='#ctPartTwentyThirdSecond' style={{ textDecoration: 'none', fontSize: '1rem', color: 'black' }}>Are Family Foundations subject to UAE CT?</a>
                        </TableCell>
                    </TableRow>
