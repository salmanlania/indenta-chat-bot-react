...
export default function CtPartTwentyfirst() {
    ...
    const ctPartTwentyfirst = {
        first: {
            heading: '1. What is taxable income?',
        ...
        second: {
            heading: '2. What standards must be used to prepare financial statements?',
        ...
        third: {
            heading: '3. Will financial statements need to be prepared on an accruals basis?',
        ...
        fourth: {
            heading: '4. What UAE CT adjustments to the financial statements will be required to calculate taxable income?',
        ...
        fifth: {
            heading: '5. What is the UAE CT treatment for any unrealised gains and losses arising from accounting fair value or impairment adjustments?',
        ...
        sixth: {
            heading: '6. What is the realisation principle, and when is income realised for UAE CT purposes?',
        ...
        seventh: {
            heading: '7. How are capital gains taxed?',
