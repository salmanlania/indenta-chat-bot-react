...
export default function CtPartFifteen() {
    ...
    const ctPartFifteen = {
        first: {
            heading: '1. Who is a Natural Person?',
            firstPara: 'The term “Natural Person” in the Corporate Tax Law means an individual.',
        },
        second: {
            heading: '2. Will individuals be subject to UAE CT?',
        ...
        third: {
            heading: '3. What is the UAE CT treatment of a sole proprietorship or civil company?',
        ...
        fourth: {
            heading: '4. Will an individual be subject to UAE CT on business income earned outside the UAE?',
        ...
        fifth: {
            heading: '5. What if an individual has multiple business activities that are in the scope of UAE CT?',
        ...
        sixth: {
            heading: '6. Will an individual’s employment income be subject to UAE CT?',
        ...
        seventh: {
            heading: '7. Will self-employed persons (e.g. freelancers) be subject to UAE CT?',
        ...
        eight: {
            heading: '8. Will income earned by an individual from bank deposits be subject to UAE CT?',
        ...
        ninth: {
            heading: '9. Will an individual be subject to UAE CT on investment returns?',
        ...
        tenth: {
            heading: '10. Will an individual be subject to UAE CT on income from real estate?',
