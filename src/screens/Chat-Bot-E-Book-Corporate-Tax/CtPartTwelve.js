...
export default function CtPartTwelve() {
    ...
    const ctPartTwelve = {
        first: {
            heading: '1. What is an investment fund?',
        ...
        second: {
            heading: '2. Will investment funds be subject to UAE CT?',
        ...
        third: {
            heading: '3. What is a recognised stock exchange?',
            firstPara: 'A recognised stock exchange includes:',
        },
        fourth: {
            heading: '4. Will a UAE based investment fund manager be subject to UAE CT?',
        ...
        fifth: {
            heading: '5. For the purpose of benefiting from the CT exemption, are both the investment fund and the fund manager required to be subject to regulatory oversight?',
        ...
        sixth: {
            heading: '6. Could a UAE-based investment manager create a UAE taxable presence for its foreign customers?',
        ...
        seventh: {
            heading: '7. Could the activities of a UAE-based investment manager result in a foreign investment fund / vehicle to be considered resident in the UAE for UAE CT purposes?',
        ...
        eighth: {
            heading: '8. Can investment holding companies and Special Purpose Vehicles used by an investment fund benefit from an exemption form UAE CT?',
