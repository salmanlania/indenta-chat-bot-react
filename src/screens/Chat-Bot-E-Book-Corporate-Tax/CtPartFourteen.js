...
export default function CtPartFourteen() {
    ...
    const ctPartFourteen = {
        ...
        second: {
            heading: '2. Will the UAE CT regime allow prior year tax losses to reduce taxable income?',
        ...
        third: {
            heading: '3. Will a change in ownership of the taxable person restrict the ability to use its tax losses?',
        ...
        fourth: {
            heading: '4. Will a group be able to utilise the tax losses of one group company against the taxable income of another group company?',
        ...
        fifth: {
            heading: '5. What are the conditions for the transfer of tax losses within a group?',
