...
export default function CtPartEighteen() {
    ...
    const ctPartEighteen = {
        first: {
            heading: '1. Will the oil and gas sector and other extractive industries be subject to UAE CT?',
        ...
        second: {
            heading: '2. Will the banking sector be subject to UAE CT?',
            firstPara: 'Yes. UAE headquartered banks and UAE branches of foreign banks will be subject to UAE CT.',
        },
        third: {
            heading: '3. Will the real state sector be subject to UAE CT?',
        ...
        fourth: {
            heading: '4. Will the asset management sector be subject to UAE CT?',
        ...
        fifth: {
            heading: '5. Will charities and other public benefit organisations be subject to UAE CT?',
        ...
        sixth: {
            heading: '6. How will international airlines and shipping companies be taxed?',
