...
export default function CtPartThirteen() {
    ...
    const ctPartThirteen = {
        first: {
            heading: '1. What is a juridical person?',
        ...
        second: {
            heading: '2. What does it mean to have a ‘separate legal personality”?',
        ...
        third: {
            heading: '3. How do you determine whether a juridical person has a “Business” that is within the scope of UAE CT?', 
        ...
        fourth: {
            heading: '4. Are foreign juridical persons subject to UAE CT in the same way as a UAE resident person?',
        ...
        fifth: {
            heading: '5. When is a foreign juridical person considered “effectively managed and controlled” in the UAE?',
        ...
        sixth: {
            heading: '6. Will UAE holding companies be subject to UAE CT?',
        ...
        seventh: {
            heading: '7. Will a sole proprietorship or civil company be treated as a juridical person for CT purposes?',
